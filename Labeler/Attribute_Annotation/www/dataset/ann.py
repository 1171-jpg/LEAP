...
# -1 irrelevant 0 false 1 true
# 真实数值是+1了
att_adj = {     'h_location':('disappears','moves somewhere new'),
            'conscious': ('unconscious', 'conscious'),
            'wearing': ('naked', 'dressed'), 
#             'wearing': ('undressed', 'dressed'), 
            'h_wet': ('dry', 'wet'), 
            'hygiene': ('dirty', 'clean'), 
            'location':('disappears','is picked up','is put down','is put on','is removed',
 'is put into a container','is taken out of a container','moved somewhere new'),
