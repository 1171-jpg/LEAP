...
def evaluate_tiered(maxStoryLength,max_story_length,num_attributes,trip_model,eval_dataloader, device, metrics, seg_mode=False, return_softmax=False, return_explanations=False, return_losses=False, verbose=True):
  if verbose:
    print('\tBeginning evaluation...')
