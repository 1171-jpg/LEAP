...
def tslm_entity_classifier_eval(maxStoryLength,max_story_length,tslmclassifier, input_ids, input_mask,
...
def evaluate_tiered(MaxStoryLength,max_story_length,
                    tslm_model,
                    trip_model,
                    eval_dataloader,
                    device,
...
# Aggregate losses
    ...
    tslm_entity_classifier_eval(MaxStoryLength,max_story_length,tslm_model,input_ids,input_mask,timestep_type_ids,preconditions,effects,att_to_num_classes,device)
